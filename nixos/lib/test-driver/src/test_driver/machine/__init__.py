...
class NspawnMachine(BaseMachine):
    ...
    def _drain_notify_socket(self) -> None:
        ...
        hangs or fails with `Transport endpoint is not connected`. This is the
        nspawn analogue of the host draining the notify socket. QEMU has no such
        socket, so is unaffected.
        """
