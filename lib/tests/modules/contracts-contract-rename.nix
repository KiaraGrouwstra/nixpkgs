...
in
{
  ...
  config = {
    ...
    # (contractDefinitions.oldName = config.contractDefinitions.newName would cause infinite recursion
    # because config.contractDefinitions is built from all contractDefinitions definitions including oldName.)
    contractDefinitions.oldName = {
      meta = {
